...
class ATTR_DLL_LOCAL udsd_media_t {
public:
  virtual ~udsd_media_t(){};
...
class ATTR_DLL_LOCAL udsd_media_disc_t : public udsd_media_t {
public:
  udsd_media_disc_t() = default;
  virtual ~udsd_media_disc_t();
...
class ATTR_DLL_LOCAL udsd_media_file_t : public udsd_media_t {
public:
  udsd_media_file_t();
  ~udsd_media_file_t();
